...
namespace ZE 
{
	...
	void MainThreadJob(GameContext* _gameContext)
	{
		...
		// Draw Debug Text
		DebugRenderer::DrawTextScreen("Zooid Engine", Vector2(10.0f, 10.0f), Vector3(1.0f, 0.0f, 0.0f));
		...
		DebugRenderer::DrawTextScreen(StringFunc::Buffer, Vector2(10.0f, _gameContext->getRenderer()->GetHeight() - 20.0f), Vector3(1.0f, 1.0f, 0.0f), 0.75f);
