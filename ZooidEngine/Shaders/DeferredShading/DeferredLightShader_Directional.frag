/**
* Deferred Light Fragment Shader for Directional Light
* by : Ahmad Fauzan
**/
...
void main()
{
	...
	vec3 result = CalcDirLight(light, norm, fragPos, depth, viewDir, albedo, specIntensity, specPower, ambient, occlusion);		
